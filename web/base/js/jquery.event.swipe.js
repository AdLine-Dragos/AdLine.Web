...
<meta content="tockiiAh679JRwAF0tvY6I+yoexlMG2Jdk6Y+TN2VLM=" name="csrf-token" />
  ...
  <input type="text" data-hotkey="/ s" name="q" id="js-command-bar-field" placeholder="Search or type a command" tabindex="1" autocapitalize="off"
    data-username="AdLine-Dragos"
      ...
      data-branch="master"
      data-sha="f70b330486ad59cfa187c74d7480f579f44ea59d"
  >
...
<div class="js-new-dropdown-contents hidden">
  <ul class="dropdown-menu">
    ...
    <li>
        <a href="/stephband/jquery.event.swipe/issues/new"><span class="octicon octicon-issue-opened"></span> New issue</a>
    </li>
    <li>
    </li>
    <li>
...
<ul class="pagehead-actions">
    ...
    <li class="js-toggler-container js-social-container starring-container ">
      <a href="/stephband/jquery.event.swipe/unstar" class="minibutton with-count js-toggler-target star-button starred upwards" title="Unstar this repo" data-remote="true" data-method="post" rel="nofollow">
        <span class="octicon octicon-star-delete"></span>
        <span class="text">Unstar</span>
      </a>
      <a href="/stephband/jquery.event.swipe/star" class="minibutton with-count js-toggler-target star-button unstarred upwards" title="Star this repo" data-remote="true" data-method="post" rel="nofollow">
        <span class="octicon octicon-star"></span>
        <span class="text">Star</span>
      </a>
      <a class="social-count js-social-count" href="/stephband/jquery.event.swipe/stargazers">155</a>
    </li>

        <li>
          <a href="/stephband/jquery.event.swipe/fork" class="minibutton with-count js-toggler-target fork-button lighter upwards" title="Fork this repo" rel="nofollow" data-method="post">
            <span class="octicon octicon-git-branch-create"></span>
            <span class="text">Fork</span>
          </a>
          <a href="/stephband/jquery.event.swipe/network" class="social-count">61</a>
        </li>
  ...
  <ul class="tabs">
    <li class="pulse-nav"><a href="/stephband/jquery.event.swipe/pulse" class="js-selected-navigation-item " data-selected-links="pulse /stephband/jquery.event.swipe/pulse" rel="nofollow"><span class="octicon octicon-pulse"></span></a></li>
    <li><a href="/stephband/jquery.event.swipe" class="js-selected-navigation-item selected" data-selected-links="repo_source repo_downloads repo_commits repo_tags repo_branches /stephband/jquery.event.swipe">Code</a></li>
    <li><a href="/stephband/jquery.event.swipe/network" class="js-selected-navigation-item " data-selected-links="repo_network /stephband/jquery.event.swipe/network">Network</a></li>
    <li><a href="/stephband/jquery.event.swipe/pulls" class="js-selected-navigation-item " data-selected-links="repo_pulls /stephband/jquery.event.swipe/pulls">Pull Requests <span class='counter'>0</span></a></li>

      <li><a href="/stephband/jquery.event.swipe/issues" class="js-selected-navigation-item " data-selected-links="repo_issues /stephband/jquery.event.swipe/issues">Issues <span class='counter'>2</span></a></li>

      <li><a href="/stephband/jquery.event.swipe/wiki" class="js-selected-navigation-item " data-selected-links="repo_wiki /stephband/jquery.event.swipe/wiki">Wiki</a></li>


    <li><a href="/stephband/jquery.event.swipe/graphs" class="js-selected-navigation-item " data-selected-links="repo_graphs repo_contributors /stephband/jquery.event.swipe/graphs">Graphs</a></li>
...
<div class="tabnav">
  ...
  <span class="tabnav-right">
    <ul class="tabnav-tabs">
          <li><a href="/stephband/jquery.event.swipe/tags" class="js-selected-navigation-item tabnav-tab" data-selected-links="repo_tags /stephband/jquery.event.swipe/tags">Tags <span class="counter ">5</span></a></li>
    </ul>
  </span>
  ...
  <ul class="tabnav-tabs">
    <li><a href="/stephband/jquery.event.swipe" class="selected js-selected-navigation-item tabnav-tab" data-selected-links="repo_source /stephband/jquery.event.swipe">Files</a></li>
    <li><a href="/stephband/jquery.event.swipe/commits/master" class="js-selected-navigation-item tabnav-tab" data-selected-links="repo_commits /stephband/jquery.event.swipe/commits/master">Commits</a></li>
    <li><a href="/stephband/jquery.event.swipe/branches" class="js-selected-navigation-item tabnav-tab" data-selected-links="repo_branches /stephband/jquery.event.swipe/branches" rel="nofollow">Branches <span class="counter ">2</span></a></li>
  </ul>
              ...
              <div class="actions">
                <div class="button-group">
                        <a class="minibutton tooltipped leftwards"
                           ...
                           href="/stephband/jquery.event.swipe/edit/master/js/jquery.event.swipe.js"
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.08360s from fe3.rs.github.com">GitHub</span>, Inc. All rights reserved.</p>
    <a class="left" href="/">
      <span class="mega-octicon octicon-mark-github"></span>
    </a>
    <ul id="legal">
  ...
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.08424' data-host='fe3'></span>
