...
<div id="slider1" class="mobile-wwd"> <a class="buttons prev" href="#">left</a>
  <div class="viewport">
    <ul class="overview">
      <li>
        <div class="pagination-centered"> <img src="assets/what_we_do.png">
          <h2>Create websites</h2>
          <p>We create the websites for you so that you can focus more on developing your business.</p>
        </div>
      </li>
      <li>
        <div class="pagination-centered"> <img src="assets/customize.png">
          <h2>Customize them</h2>
          <p>Have a unique presence on the web by customizing your website. You will not have to move a finger!</p>
        </div>
      </li>
      <li>
        <div class="pagination-centered"> <img src="assets/documentation2.png">
          <h2>Document them</h2>
          <p>Provide a thorough documentation, ensuring an easy maintenance process afterwards.</p>
        </div>
      </li>
      <li>
        <div class="pagination-centered"> <img src="assets/prof_service.png">
          <h2>Deliver them</h2>
          <p>Deliver a professional, high-quality product that will help you overcome the competition.</p>
        </div>
      </li>
...
<div class="row-fluid shortInfo">
  <div class="span3 pagination-centered clearfix"> <img src="assets/fast_service.png">
    <h2>Fast-service</h2>
    <p>Our aim is to deliver your website, with your help, in less than 3 days, whenever possible!</p>
  </div>
  <div class="span3  pagination-centered clearfix"> <img src="assets/no_headaches.png">
    <h2>No headaches</h2>
    <p>Us taking care of everything means more free time to enjoy for yourself.</p>
  </div>
  <div class="span3 pagination-centered clearfix"> <img src="assets/price-quality.png">
    <h2>Price/Quality</h2>
    <p>We guarantee the best price/quality ratio on the market. You can easily afford a website that will make you stand out!</p>
  </div>
  <div class="span3 pagination-centered clearfix"> <img src="assets/communication.png">
    <h2>Great support</h2>
...
<div id="slider2" class="mobile-wwd"> <a class="buttons prev" href="#">left</a>
  <div class="viewport">
    <ul class="overview">
      <li>
         <div class="pagination-centered"> <img src="assets/fast_service.png">
    <h2>Fast-service</h2>
    <p>Our aim is to deliver your website, with your help, in less than 3 days, whenever possible!</p>
  </div>
      </li>
      <li>
       <div class="pagination-centered"> <img src="assets/no_headaches.png">
    <h2>No headaches</h2>
    <p>Us taking care of everything means more free time to enjoy for yourself.</p>
  </div>
      </li>
      <li>
        <div class="pagination-centered"> <img src="assets/price-quality.png">
    <h2>Price/Quality</h2>
    <p>We guarantee the best price/quality ratio on the market. You can easily afford a website that will make you stand out!</p>
  </div>
      </li>
      <li>
        <div class="pagination-centered"> <img src="assets/communication.png">
    <h2>Great support</h2>
    <p>We consider a good communication with our customers the key to a successful collaboration.</p>
  </div>
      </li>
